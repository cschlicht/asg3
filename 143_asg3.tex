...
\item accuracy:  24.34%; (non-O)
\item accuracy:   4.06%; precision:   0.00%; recall:   0.00%; FB1:   0.00
\item LOC: precision:   0.00%; recall:   0.00%; FB1:   0.00  1
\item MISC: precision:   0.00%; recall:   0.00%; FB1:   0.00  0
\item ORG: precision:   0.00%; recall:   0.00%; FB1:   0.00  0
\item PER: precision:   0.00%; recall:   0.00%; FB1:   0.00  0

\item

\item Test Set:
\item processed 46666 tokens with 5616 phrases; found: 1 phrases; correct: 0.
\item accuracy:  23.66%; (non-O)
\item accuracy:   4.11%; precision:   0.00%; recall:   0.00%; FB1:   0.00
\item LOC: precision:   0.00%; recall:   0.00%; FB1:   0.00  1
\item MISC: precision:   0.00%; recall:   0.00%; FB1:   0.00  0
\item ORG: precision:   0.00%; recall:   0.00%; FB1:   0.00  0
\item PER: precision:   0.00%; recall:   0.00%; FB1:   0.00  0
